...
💻 Foco em Desenvolvimento de Software e Ciência de Dados  
🌱 Atualmente aprendendo Python, JavaScript e SQL  

## 🚀 Meus Projetos
- 🧮 [Calculadora em Python](https://github.com/raphaelcosta/calculadora-python)
- 🌐 [Site pessoal em HTML/CSS](https://github.com/raphaelcosta/portfolio-site)
- 📊 [Análise de dados com Pandas](https://github.com/raphaelcosta/analise-dados)

## 📫 Contato
- Email: raphael@email.com  
- LinkedIn: [linkedin.com/in/raphaelcosta](https://linkedin.com/in/raphaelcosta)
